...
Complete the source code in order to print whether the number stored in the variable number is positive or negative. Source code:
```
#!/usr/bin/python3
import random
...
Complete the source code in order to print the last digit of the number stored in the variable number. Source code:
```
#!/usr/bin/python3
import random
